      ...
      {reviewers.length === 0 ? (
        ...
        <div className="overflow-x-auto rounded-xl border border-gray-200 bg-white">
          <table className={`w-full table-fixed divide-y divide-gray-200 ${tableMinWidth}`}>
            {/* Status and link form one progress signal. Follow-up controls,
                downloads, and secondary controls each get a dedicated lane so
                their labels and triggers remain aligned at narrow widths. */}
            <colgroup>
