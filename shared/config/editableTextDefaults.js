...
export const EDITABLE_TEXT_DEFAULTS = [
  ...
  {
    key: 'email.reviewer_release.subject',
    label: 'Accepted reviewer release subject',
    description: 'Default subject for thanking an accepted reviewer who is released because enough reviews were received.',
    multiline: false,
    placeholders: [],
    group: 'reviewers',
    emailKey: 'email.reviewer_release',
    emailLabel: 'Accepted reviewer release',
  },
  {
    key: 'email.reviewer_release.body',
    label: 'Accepted reviewer release body',
    description: 'Default thank-you copy for an accepted reviewer released because enough reviews were received.',
    multiline: true,
    placeholders: ['{{greeting}}', '{{reviewerName}}', '{{proposalClause}}', '{{signature}}'],
    group: 'reviewers',
    emailKey: 'email.reviewer_release',
  ...
  },
  {
    ...
    description: 'Default subject line for the Workbench “Share for the deliberation session” email. Staff can still edit it before creating a preview. Blank retains the built-in wording. Mustache {{tokens}}, not [brackets].',
    multiline: false,
  ...
  },
  {
    ...
    description: 'Default message for the Workbench “Share for the deliberation session” email. Blank retains the built-in wording. The briefing-page section and session details are rendered separately below.',
    multiline: true,
    placeholders: [],
    group: 'internal',
    emailKey: 'email.deliberation_share',
  ...
  },
  {
    ...
    description: 'Bold label before the briefing link. Blank retains “Briefing page:”. This changes wording only; the application still supplies the link.',
    multiline: false,
    placeholders: [],
    group: 'internal',
    emailKey: 'email.deliberation_share',
  ...
  },
  {
    ...
    description: 'Clickable text for the briefing-page link. Blank retains “Open the deliberation briefing”. The destination URL cannot be changed here.',
    multiline: false,
    placeholders: [],
    group: 'internal',
    emailKey: 'email.deliberation_share',
  ...
  },
  {
    ...
    description: 'Wording after the briefing link. Blank retains the built-in materials description. This does not change which materials the briefing page contains.',
    multiline: false,
    placeholders: [],
    group: 'internal',
    emailKey: 'email.deliberation_share',
  ...
  },
  {
    ...
    description: 'Wording immediately before the generated expiration date. Blank retains “The link expires on”. Do not enter a date; the application supplies it from the live link.',
    multiline: false,
    placeholders: [],
    group: 'internal',
    emailKey: 'email.deliberation_share',
  ...
  {
    key: 'email.site_visit_materials_invite.subject',
    label: 'Site-visit materials invitation subject',
    description: 'Default subject for the applicant materials invitation. Mustache {{tokens}} only.',
    multiline: false,
    placeholders: ['{{proposalTitle}}'],
    group: 'applicants',
    emailKey: 'email.site_visit_materials_invite',
    emailLabel: 'Site-visit materials invitation',
  },
  {
  ...
  {
    key: 'email.site_visit_materials_reminder.subject',
    label: 'Site-visit materials reminder subject',
    description: 'Default subject for the applicant materials reminder. Mustache {{tokens}} only.',
    multiline: false,
    placeholders: ['{{proposalTitle}}'],
    group: 'applicants',
    emailKey: 'email.site_visit_materials_reminder',
    emailLabel: 'Site-visit materials reminder',
  },
  {
...
export const EDITABLE_TEXT_GROUPS = [
  ...
  { id: 'applicants', title: 'Applicant emails', description: 'Default copy for applicant-facing email workflows before an award (site-visit materials).' },
