...
export const EDITABLE_TEXT_DEFAULTS = [
  ...
  },
  {
    ...
    description: 'Default message for the Workbench “Share for the deliberation session” email. Blank retains the built-in wording. The briefing-page link and session details are rendered separately and are not editable here.',
    multiline: true,
    placeholders: [],
    group: 'internal',
    emailKey: 'email.deliberation_share',
