...
describe('reviewer table geometry', () => {
  ...
  test('uses dedicated download and More columns when management controls are present', async () => {
    let container;
    await act(async () => {
      ({ container } = render(
        <ReviewerManagePanel
  ...
  test('keeps follow-up, download, and More controls in dedicated aligned lanes', async () => {
    let container;
    await act(async () => {
      ({ container } = render(
        <ReviewerManagePanel
