...
describe('WorkbenchViewsNav scope preservation', () => {
  test('carries scope for the three scope consumers, but not for Final writeups, Staff deliberations, or Initial assessments', () => {
    ...
    expect(screen.getByRole('link', { name: 'Staff deliberations' })).toHaveAttribute('href', '/workbench?view=staff-deliberations&programId=p1&cycleCode=J27');
  });
