...
describe('manual thank-you render strips the retired {{honorariumNote}} token', () => {
  ...
  test.each([false, null, undefined])('opt-out %p → token removed without payment language', async (v) => {
