      ...
      proposals: [
        {
          ...
          reviewSynthesisState: {
            ...
            resolvedCount: 0,
            blockingCount: 1,
            blockers: [{ suggestionId: 'sug-b1', reason: 'missing_current_token', name: null, accepted: true, emailSentAt: null }],
            ...UNAVAILABLE_JOB_STATE,
          },
