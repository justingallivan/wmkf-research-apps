 ...
 *   into an email body.
 */
export async function mintAndStore({ suggestionId, requestId, expiresAt, ops = DEFAULT_OPS, actingUserSystemId, ifMatch } = {}) {
  ...
  await setExternalToken(suggestionId, { hash, expiresAt }, { actingUserSystemId, ifMatch });
