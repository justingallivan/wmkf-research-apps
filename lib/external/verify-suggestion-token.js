...
const SUGGESTION_SELECT = [
  ...
  // Hold step: when the reviewer placed a hold (agreed in principle). Read here so
  // the portal's HoldView/audit can show "held on {date}" (the portal reads this
  // verified row, not the adapter FIELD_SELECT).
  'wmkf_heldat',
  'wmkf_reviewstatus',
  'wmkf_emailsentat',
