...
// Formatting accepted from current and historical reviewer editors. The current
// external toolbar exposes the compact inline set; the structural tags remain
// accepted so previously saved reviews and the staff rescue editor retain their
// formatting. Nothing else: no images, no tables, no spans/divs, no style/class.
const ALLOWED_TAGS = [
  'p', 'br',
