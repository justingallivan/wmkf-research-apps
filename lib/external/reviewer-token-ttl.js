...
// Intentional operational cushion: accepted reviewers keep access through the
// Board meeting. Normal deadline extensions are on the order of two weeks, so
// editing a due date never needs to rotate or extend an already-issued 90-day link.
export const TOKEN_LONG_WINDOW_DAYS = 90;
