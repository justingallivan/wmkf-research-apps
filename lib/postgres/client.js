 ...
 *   both variables when neither is set. `pg` is required statically at
 *   module top so the ratchet's AST-only classification (plan §2 rule 12)
 *   sees a literal specifier. Recorded lifecycle changes for the
