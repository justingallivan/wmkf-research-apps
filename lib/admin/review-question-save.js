...
// 2 ratings. The editor must always keep all three — they are the backbone of the
 ...
 * = all present. The route rejects a non-empty result (400) so staff cannot drop
 * affiliation/riskLevel/overallAssessment.
 */
