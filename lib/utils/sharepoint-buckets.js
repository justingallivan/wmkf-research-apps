 ...
 *   archive folder name).
 * @param {{requireResolvedParents?: boolean}} [options] - Governed writers set
 *   `requireResolvedParents` so a best-effort library fallback cannot become a
 *   write destination.
