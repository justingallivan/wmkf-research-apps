 ...
 *   server-side by `pathname` with `UPLOADS_BLOB_RW_TOKEN` via `@vercel/blob`'s
...
import { observeReviewerFindWarmEffect } from '../services/workbench/reviewer-find-warm-observation.js';
