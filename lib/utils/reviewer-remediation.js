...
const ACTIONS = Object.freeze({
  ...
  resolve_address_conflict: 'Review email choice',
  ...
  retry_record_check: 'Retry record check',
...
const CONTRACT = Object.freeze({
  ...
  address_conflict_pending: ['resolve_address_conflict', 'set_aside'],
  orcid_email_split: ['choose_identity', 'verify_person_and_address', 'create_repair_request', 'set_aside'],
  contact_linked_elsewhere: ['retry_record_check', 'set_aside'],
  email_conflict: ['retry_record_check', 'set_aside'],
  ambiguous_email_owner: ['retry_record_check', 'set_aside'],
  person_inactive: ['retry_record_check', 'set_aside'],
  inactive_email_owner: ['retry_record_check', 'set_aside'],
