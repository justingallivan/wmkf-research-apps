...
const CONTRACT = Object.freeze({
  ...
  // No trusted institutional domain is a deliberate not-applicable result, not
  // a transient failed check. Retrying cannot establish the missing domain.
  eligibility_no_trusted_domains: ['create_repair_request', 'set_aside'],
