...
const CONTRACT = Object.freeze({
  ...
  contact_linked_elsewhere: ['open_merge', 'verify_person_and_address', 'create_repair_request', 'set_aside'],
  email_conflict: ['open_merge', 'choose_identity', 'replace_address', 'set_aside'],
  ambiguous_email_owner: ['open_merge', 'choose_identity', 'replace_address', 'set_aside'],
  person_inactive: ['open_record_repair', 'choose_identity', 'create_distinct_person', 'set_aside'],
  inactive_email_owner: ['open_record_repair', 'choose_identity', 'replace_address', 'set_aside'],
