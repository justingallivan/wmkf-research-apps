...
export const LAST_REVIEWED_AT = '2026-09-12';
...
export const MODEL_PRICING = {
  ...
  // Opus 5 and 4.5+ tier: $5 input / $25 output
  ...
  // Sonnet 5: $2 input / $10 output. Anthropic made the launch rate permanent
  // in August 2026; the previously announced 2026-09-01 increase was cancelled.
  ...
  // ─── OpenAI ───
  // GPT-5.6 Sol: $4 input / $20 output per MTok.
