...
export const LAST_REVIEWED_AT = '2026-05-23';
...
export function lookupPricing(modelId) {
  ...
  // Longest-prefix match. The sort guarantees `claude-opus-4-7` is tried
  // before `claude-opus-4`, so a Opus 4.7 dated id matches the right tier.
