  ...
  if (!honorariumRequestId) {
    ...
    const createBody = {
      ...
      ...(HONORARIUM_CURRENCY_ID
        ...
        : {}),
      // TODO(strategy doc §8/§9): once Connor adds the honorarium→proposal lookup
      // (proposed wmkf_relatedproposal, akoya_request → akoya_request), bind it here.
      // CONFIRM the exact navigation-property name/casing from live metadata first
      // (§4 casing hazard):
