...
export async function executePrompt({
  ...
  try {
    ...
    claudeResp = await callClaude(promptRow, composed, modelInfo, outputSchema, maxTokensOverride);
...
async function callClaude(promptRow, { system, body }, modelInfo, outputSchema, maxTokensOverride = null) {
