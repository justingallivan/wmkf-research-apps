 ...
 * test), off in production — so enforcement is exercised everywhere except
 * the one environment where flipping it on is a deliberate, later deploy
 * decision (Stage 7 plan, work item 3). There is no committed
