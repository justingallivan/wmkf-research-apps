...
export async function fetchWithTimeout(url, options, timeout) {
  ...
  // in a Dynamics caller passes one today; Graph has a separate transport
  // helper. If a future Dynamics caller needs caller-driven cancellation,
  // compose signals here (AbortSignal.any)
