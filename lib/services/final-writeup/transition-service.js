...
// Lifecycle acceptance (REVIEW, or FINAL with the complete leadership
// checkpoint) is shared with the acknowledgement and dashboard readers via
// ./leadership-checkpoint.js so every surface fails closed on the same rows.
