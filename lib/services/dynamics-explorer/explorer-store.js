/**
 * Postgres helpers for the Dynamics Explorer chat loop: fail-soft user role
 * and active restriction reads, and fire-and-forget query logging with its
 * legacy-column fallback insert.
 *
