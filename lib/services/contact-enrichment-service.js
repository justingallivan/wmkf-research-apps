...
// Stage 9 (Checkpoint D, highest-risk): the five Tier 0-4 bodies +
...
class ContactEnrichmentService {
  ...
  static async enrichCandidate(candidate, options = {}) {
    ...
    // returns 'finalize' (a terminal email was found — Tier 0's is always
    // recent; Tier 1's only when pubmedResult.isRecent) or 'continue'.
