...
class ContactEnrichmentService {
  ...
  static async enrichCandidate(candidate, options = {}) {
    ...
    if (candidate.affiliation) {
      ...
      if (affiliationEmail) {
        ...
        return this._finalize(candidate, result, { useSerpSearch, serpApiKey: credentials.serpApiKey, onProgress });
      }
    }
   ...
   */
  static async _finalize(candidate, result, { useSerpSearch, serpApiKey, onProgress }) {
