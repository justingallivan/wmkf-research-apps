...
// These field names exist only on akoya_request, so the guard is independent of
// the write target: it refuses them anywhere in a write body, including nested
// deep-insert payloads, whatever entity or URL form the write addresses.
// lib/dataverse/client.js (CommonJS) keeps a parity copy of these names.
