...
function validateMetadata(metadata, blockers) {
  ...
  for (const [field, spec] of Object.entries(metadata.fields)) {
    ...
    if (spec.requiredLevel === 'SystemRequired' && !POLICY_FIELDS.has(field) && spec.createable === true) {
...
export function compileTestRequestDraft(input = {}) {
  ...
  return {
    ...
    replacedFields: [FIXED_FIELDS.applicant, FIXED_FIELDS.marker, FIXED_FIELDS.runId, FIXED_FIELDS.responseReminder, FIXED_FIELDS.reviewReminder],
    blockers,
