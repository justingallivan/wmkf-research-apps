...
function emptyResult(dryRun) {
  return { dryRun, eligibilityIsProvisional: dryRun, scanned: 0, eligible: 0, sent: 0, skippedNothingMissing: 0, skippedNoRecipient: 0, skippedNoSender: 0, skippedLinkUnreadable: 0, claimLost: 0, sendFailed: 0, receiptFailed: 0, errors: [] };
}
