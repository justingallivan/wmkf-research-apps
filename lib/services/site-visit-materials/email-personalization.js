...
const FIELD_TOKENS = Object.freeze({
  invitation: {
    ...
    body: new Set(['proposalTitle', 'institution', 'visitDate', 'dueDate', 'checklist', 'uploadLink', 'signature', 'piLastName', 'liaisonFullName', 'programCoordinatorName']),
  },
  reminder: {
    subject: new Set(['proposalTitle']),
    body: new Set(['proposalTitle', 'institution', 'visitDate', 'dueDate', 'missingItemsGrammar', 'missingItems', 'uploadLink', 'signature', 'piLastName', 'liaisonFullName', 'programCoordinatorName']),
  },
});
