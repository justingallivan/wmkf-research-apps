 ...
 *     job dispatch lives; recordFailure bookkeeping deliberately runs OUTSIDE
 *     it, pinned by drain-submissions-dal-context.test.js). The duplicate-PK
 *     recovery read keeps its historical legacy-bypass label
 *     ('drain-recover-request-created') unchanged.
