 ...
 *     attempt whose send was requested (exact version, write-once items);
...
import { getLatestSendRequestedAttempt } from '../pre-site-visit/distribution-store';
...
const DEFAULT_DEPENDENCIES = Object.freeze({
  ...
  getLatestAttempt: getLatestSendRequestedAttempt,
