 ...
 * page's visit line must not depend on which one Dataverse listed first. Rule
 * [ASSUMED, owner may adjust]: the earliest scheduled end wins; rows without
 * an end sort last; ties break on activity id.
 */
