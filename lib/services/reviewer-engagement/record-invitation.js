...
// generation mark-as-sent. Preserved verbatim: raw entity fields, no
// `ifMatch`, no `actingUserSystemId` — open owner decision D2 (carried, not
// taken; current behavior preserved pending it).
