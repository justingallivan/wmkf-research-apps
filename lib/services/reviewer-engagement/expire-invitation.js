 ...
 *
 * `isPastCutoff` lived here from Stage 3E until 2026-09-06 (S490 hygiene);
 * it is now `lib/utils/past-cutoff.js`, imported by both this module and the
 * sweep's discovery pass.
 */

import { getByIdWithSelect, expireInvitationResponse, isExcluded } from '../../dataverse/adapters/reviewer-suggestion.js';
import { queryRequests } from '../../dataverse/adapters/grant-request.js';
import { isConcreteEtag } from '../../utils/etag.js';
import { isPastCutoff } from '../../utils/past-cutoff.js';
 ...
 * which owns skip classification for 412 and not-found.
 *
 * @param {object} args
...
export async function expireInvitation({ suggestion, cutoffIso, nowIso, actingUserSystemId }) {
  ...
  await expireInvitationResponse(s.wmkf_appreviewersuggestionid, nowIso, {
    actingUserSystemId,
    ifMatch: fresh._etag,
  });
