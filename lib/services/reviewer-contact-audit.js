...
function detectSignals(ce = {}) {
  ...
  // the Claude name-mismatch sets emailRejectedReason on the stored result. (The
  // SerpAPI name-mismatch email is nulled in place and is NOT detectable here —
  // see the spec's Slice-2a pre-null capture hook note.)
