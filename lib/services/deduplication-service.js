...
class DeduplicationService {
  ...
  /**
   * Resolve only a pre-existing lexical/direct COI candidate. This is the
   * no-widening firewall: W0 may refute or exempt a match, but a lexical
   * non-match stays a non-match even if the provider later returns the same id.
   */
