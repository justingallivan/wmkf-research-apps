...
/**
 * List the roster for a request: { active, excluded, ineligible, savedKeys, allNames }.
...
function rosterFromRows(rows) {
  ...
  return { active, excluded, ineligible, savedKeys, allNames };
}
