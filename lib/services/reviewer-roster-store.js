          ...
          SET status = CASE
              ...
              candidate = CASE
                ...
                THEN ${JSON.stringify(genericCandidate)}::jsonb || jsonb_build_object(
                  ...
                  'stageFreshness', '{}'::jsonb,
                  'stageRefresh', reviewer_find_roster.candidate->'stageRefresh',
                  'staffIdentityConfirmation', reviewer_find_roster.candidate->'staffIdentityConfirmation',
                  'pdIdentityConfirmed', reviewer_find_roster.candidate->'pdIdentityConfirmed',
                  'pdIdentityConfirmationId', reviewer_find_roster.candidate->'pdIdentityConfirmationId',
                  'manualContactFields', reviewer_find_roster.candidate->'manualContactFields',
                ...
                ELSE ${JSON.stringify(genericCandidate)}::jsonb || jsonb_strip_nulls(jsonb_build_object(
                  'stageFreshness', '{}'::jsonb,
                  'stageRefresh', reviewer_find_roster.candidate->'stageRefresh',
                  'staffIdentityConfirmation', reviewer_find_roster.candidate->'staffIdentityConfirmation',
                  'pdIdentityConfirmed', reviewer_find_roster.candidate->'pdIdentityConfirmed',
