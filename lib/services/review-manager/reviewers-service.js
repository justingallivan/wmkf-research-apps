 ...
 * order. Sequential awaited writes stop at the first failure, reporting the
 * confirmed prefix, uncertain attempt and untouched suffix. A failed attempt
 * may have committed before its response was lost; no rollback or retry occurs.
 *
...
/**
 * Internal carrier for an attempted lifecycle operation that did not resolve.
 * The route owns HTTP sanitation; cause remains the original adapter failure.
 * failedIds identifies an uncertain attempt, not proof that it did not commit.
 */
