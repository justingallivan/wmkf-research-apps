 ...
 * completion timestamp, and honorarium-eligibility disposition in one ETag-bound
 * suggestion PATCH. It never writes the linked honorarium request.
 */
 ...
 */
export async function closeReview({ suggestionId, disposition, actingUserSystemId, authorizedRequestId }) {
