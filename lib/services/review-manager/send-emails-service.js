 ...
 * the single service call). Post-send bookkeeping (`recordDeliveredEmail`,
 * called at the existing post-loop site) is extracted to
 * `reviewer-engagement/record-email-outcome.js` (Reviewer Lifecycle Stage 3E);
 * scan orchestration, transport, streaming and correlation stay here.
 *
