 ...
 * the invitation stamp deliberately stays inline in the send loop) is
 * extracted to `reviewer-engagement/record-email-outcome.js` (Reviewer
 * Lifecycle Stage 3E); scan orchestration, transport, streaming and
 * correlation stay here.
 *
