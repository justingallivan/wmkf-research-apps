...
export async function generateResearch(input, config, { beforePaidCall, deadlineMs = null, actingUserSystemId = null, userProfileId = null, execute = executePrompt, openAlexSearch = (...args) => OpenAlexService.searchWorks(...args), pubmedSearch = (...args) => PubMedService.search(...args) } = {}) {
...
export async function generateEntry(input, research, config, { beforePaidCall, deadlineMs = null, actingUserSystemId = null, userProfileId = null, execute = executePrompt } = {}) {
