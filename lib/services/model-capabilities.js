/**
 * Reviewed request-shaping capabilities for every Executor provider.
 *
...
export const LAST_CAPABILITY_REVIEWED_AT = '2026-09-12';
...
export const MODEL_CAPABILITIES = {
  'gpt-5.6-sol': {
    ...
    // Conservative Phase A allow-list: OpenAI's published GPT-5.6 guidance
    // does not verify temperature compatibility for Chat Completions at the
    // model's default medium reasoning effort. Keep omitted until verified.
    supportsTemperature: false,
    supportsEffort: true,
    defaultEffort: 'medium',
    thinkingMode: 'configurable_reasoning',
    // Phase A deliberately retains post-hoc Executor validation instead of
    // enabling provider-native structured output.
    supportsStructuredOutput: false,
    maxInputTokens: 1_050_000,
    maxOutputTokens: 128_000,
    refusalSemantics: 'message_refusal_or_content_filter',
    requiresRefusalHandling: true,
    zeroDataRetentionEligible: true,
    dataRetentionClass: 'standard_30d',
    reviewedAt: '2026-09-12',
    source: 'https://developers.openai.com/api/docs/models/gpt-5.6-sol',
    apiSource: 'https://developers.openai.com/api/reference/resources/chat/subresources/completions/methods/create',
    retentionSource: 'https://developers.openai.com/api/docs/guides/your-data',
  },
  'claude-fable-5-1': {
    provider: 'anthropic',
    family: 'fable',
