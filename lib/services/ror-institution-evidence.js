...
function parseOrganizationSpans(value) {
  ...
  // A slash can separate a joint appointment or alternative institutions.
  // Until those meanings are source-adjudicated, resolving the combined text
  // as one organization could silently discard a second affiliation.
  if (text.includes('/')) {
