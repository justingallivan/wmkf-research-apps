 ...
 *
 * Each retained DOCX owns the approved header/footer/branding/page geometry and one
...
export const REVIEW_DOCX_TEMPLATES = Object.freeze({
  individual: Object.freeze({
    ...
    version: 4,
    relativePath: 'shared/templates/reviews/individual-review-v4.docx',
  }),
  combined: Object.freeze({
    id: 'combined-review',
    version: 4,
    relativePath: 'shared/templates/reviews/combined-review-v4.docx',
  }),
});
...
function templatePath(kind) {
  if (kind === 'individual') {
    return path.join(process.cwd(), 'shared', 'templates', 'reviews', 'individual-review-v4.docx');
  }
  if (kind === 'combined') {
    return path.join(process.cwd(), 'shared', 'templates', 'reviews', 'combined-review-v4.docx');
  }
