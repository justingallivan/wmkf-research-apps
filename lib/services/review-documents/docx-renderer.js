...
export const REVIEW_DOCX_TEMPLATES = Object.freeze({
  individual: Object.freeze({
    ...
    version: 2,
    relativePath: 'shared/templates/reviews/individual-review-v2.docx',
  }),
  combined: Object.freeze({
    id: 'combined-review',
    version: 2,
    relativePath: 'shared/templates/reviews/combined-review-v2.docx',
  }),
});
...
function templatePath(kind) {
  if (kind === 'individual') {
    return path.join(process.cwd(), 'shared', 'templates', 'reviews', 'individual-review-v2.docx');
  }
  if (kind === 'combined') {
    return path.join(process.cwd(), 'shared', 'templates', 'reviews', 'combined-review-v2.docx');
  }
