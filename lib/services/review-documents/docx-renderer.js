...
export const REVIEW_DOCX_TEMPLATES = Object.freeze({
  individual: Object.freeze({
    ...
    version: 3,
    relativePath: 'shared/templates/reviews/individual-review-v3.docx',
  }),
  combined: Object.freeze({
    id: 'combined-review',
    version: 3,
    relativePath: 'shared/templates/reviews/combined-review-v3.docx',
  }),
});
...
function templatePath(kind) {
  if (kind === 'individual') {
    return path.join(process.cwd(), 'shared', 'templates', 'reviews', 'individual-review-v3.docx');
  }
  if (kind === 'combined') {
    return path.join(process.cwd(), 'shared', 'templates', 'reviews', 'combined-review-v3.docx');
  }
