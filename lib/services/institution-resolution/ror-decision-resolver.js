...
/**
 * Claim-oriented ROR decision policy shared by production shadow resolution
 * and the frozen falsification benchmark. Provider rank and chosen flags are
 * retrieval evidence only; explicit vetoes run before scoring.
 */
const { assertCandidateInput } = require('./candidate-contract');
