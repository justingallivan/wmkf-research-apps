...
import { assertExecutorBudgetForPromptModel } from './executor-budget-service.js';
...
export async function seedPromptRow({ promptName, recordData, force = false, now } = {}) {
  ...
  await assertExecutorBudgetForPromptModel(promptName, recordData?.wmkf_ai_model || null);
