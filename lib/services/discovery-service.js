    ...
    if (!verificationContract.enabled) {
      ...
      for (const suggestion of normalizedSuggestions) {
        onProgress({
          stage: 'verification',
          status: 'skipped',
          message: `${this.VERIFICATION_SKIPPED_REASON} ${suggestion.name}`,
        });
        unverified.push(this.unverifiedSuggestion(suggestion, this.VERIFICATION_SKIPPED_REASON));
      }
