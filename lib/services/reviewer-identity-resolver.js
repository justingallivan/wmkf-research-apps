 ...
 *     sufficient ALONE to reach `probable`. Later OpenAlex/ORCID spine rules can
 *     classify stronger corroboration as `confirmed`; persistence adapters cap
 *     automated decisions at `probable`, reserving stored `confirmed` for the
 *     transitional reviewer-attestation path.
...
const { IDENTITY_LINEAGE_FIELDS } = require('../utils/reviewer-identity-fields');
...
const RESOLVER_SOURCED_FIELDS = IDENTITY_LINEAGE_FIELDS;
