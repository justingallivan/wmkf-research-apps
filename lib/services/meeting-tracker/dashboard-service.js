...
const DEFAULT_DEPENDENCIES = Object.freeze({
  ...
  getMaterialsSummaries: getMaterialsSummaryByRequests,
});
...
export async function loadMeetingTrackerDashboard(
  ...
  const documentIds = requests
    ...
    .filter(Boolean);
  const [documents, schedules, activeVisits, materialsByRequest] = await Promise.all([
    ...
    dependencies.getMaterialsSummaries({
      requestIds,
