...
export class GraphService {
  ...
  static async getSiteId() {
    ...
    try {
      ...
      throw buildServiceError('graph', { status: 500 }, `SHAREPOINT_SITE_URL is not a valid URL: "${siteUrl}"`);
    }
   ...
   * @returns {Promise<{ id: string, name: string, size: number, webUrl: string }>}
   */
