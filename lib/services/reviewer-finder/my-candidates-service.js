  ...
  for (const s of suggestions) {
    ...
    if (!byRequest[reqId]) {
      byRequest[reqId] = {
        ...
        // truth (owner decision 2026-09-08); the stored wmkf_grantcyclecode
        // only fills in for the rare request with no meeting date. The
        // picker override the stored value once served was removed 2026-09-06
        // (Stage 7 decision D4).
        grantCycleCode: request.cycleCode || s.wmkf_grantcyclecode || null,
