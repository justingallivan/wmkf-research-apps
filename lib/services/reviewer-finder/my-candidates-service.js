...
export async function patchMyCandidates({ body = {}, actingUserSystemId = null }) {
  ...
  try {
    ...
    if (reviewDueDateOverride !== undefined) {
      if (reviewDueDateOverride !== null && !isYmd(reviewDueDateOverride)) {
        throw new MyCandidatesError('reviewDueDateOverride must be a YYYY-MM-DD date or null', 400);
      }
      if (reviewDueDateOverride !== null && !isCurrentOrFutureYmd(reviewDueDateOverride)) {
        throw new MyCandidatesError('reviewDueDateOverride must be today or later', 400);
      }
      lifecycle.reviewDueDateOverride = reviewDueDateOverride;
    }
