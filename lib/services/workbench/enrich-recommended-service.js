...
function stage2EvidenceAssertion(candidate, verificationInstitution) {
...
function stage2RecordedAssertion(candidate, enrichment, finalAffiliation) {
  ...
  const sourceContract = {
    ...
    pubmed_recency: { sourceType: 'publication', currentness: 'historical' },
