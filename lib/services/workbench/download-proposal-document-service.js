 ...
 * of the Proposal-tab Phase I, Phase II, or canonical AI Materials documents the list
 * service surfaces for this request — not just any file under the request
 * folder. Re-derived from the request's own record (never from raw query
 * params). Library allowlisting is additionally enforced by GraphService.
 *
