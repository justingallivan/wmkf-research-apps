 ...
 */
export async function loadDashboard({ azureEmail, profileId, callerSystemId, cycleCode, scope, includeSetAside, programId }) {
  ...
  if (!cycleCode) {
    return listCycles(pd, callerSystemId, programScope);
  }
 ...
 */
async function listCycles(pd, callerSystemId, programScope) {
  ...
  for (const r of records) {
    ...
    const belongsToCaller = callerSystemId
