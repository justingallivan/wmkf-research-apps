...
import { preferApplicantInstitution } from '../../../shared/utils/institution';
...
function projectProposal(r, c, isSuperuser, callerSystemId) {
  ...
  return {
    ...
    institution: preferApplicantInstitution(r.wmkf_organizationname, r._akoya_applicantid_value_formatted),
