 ...
 *
 * Render contract v6 uses the v5 OOXML bytes and retains the non-fatal
 * editorial paragraph/name behavior from v5. Template v5 retains v4's
 * first-page spacing while pinning the metadata table to fixed columns with a
 * 1.5-inch label column. It also retains v3's non-wrapping Recommendation
 * cells and pins the
