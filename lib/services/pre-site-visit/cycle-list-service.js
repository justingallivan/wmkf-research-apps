...
function projectRow(row, request, isCurrent, { siteVisitStartIso, siteVisit, everSent, session = null }) {
...
export async function listPreSiteVisitDrafts({ cycleCode, scope = 'all', callerSystemId = null }) {
  ...
  const [siteVisitRows, sentIds, scheduleByRequest] = await Promise.all([
