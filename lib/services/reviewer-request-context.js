...
export function projectReviewerRequestContext(request, coPIs = [], applicantAccount = null) {
  ...
  return {
    ...
    applicantInstitutionNames: dedupeNames([
      request._akoya_applicantid_value_formatted,
      request.wmkf_organizationname,
...
export async function loadReviewerRequestContext(requestId) {
  ...
  return projectReviewerRequestContext(request, coPIs, applicantAccount);
}
