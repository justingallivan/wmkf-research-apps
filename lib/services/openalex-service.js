...
const OPENALEX_POLITE_MAILTO = process.env.OPENALEX_POLITE_MAILTO || 'apps@wmkeck.org';
    ...
    try {
      const response = await safeFetch(url, {
        headers: {
          ...
          'User-Agent': `WMKF-Reviewer-Finder/1.0 (mailto:${OPENALEX_POLITE_MAILTO})`,
        },
