 ...
 * dispatches all user-preference operations here by default. WAVE1_BACKEND_PREFS
 * is retained as a fail-loud opt-out signal — setting it to `postgres` now
 * throws because the table no longer exists.
 *
