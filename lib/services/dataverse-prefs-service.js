 ...
 * SQL error and returns `{}`/false (see lib/services/database-service.js:474,
 * 519, 540, 562). The dispatch comment at :43-47 says "fails loudly" but the
 * catch blocks swallow the error. So the opt-out silently returns empty
 * preferences instead of throwing. Real fail-loud behavior requires either
 * removing the catches in the dead Postgres branches or deleting them entirely.
 *
