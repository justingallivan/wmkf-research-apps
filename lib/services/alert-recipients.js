...
const SEED_CATEGORIES = [
  ...
  { key: 'virus-detection',  description: 'Cloudmersive flagged an uploaded file as malicious. Recipients are notified alongside the PD on the related request (when resolvable).' },
  ...
  { key: 'grantee-deliverables', description: 'A grantee submitted their abstract/image deliverables. Recipients are notified alongside the assigned PD on the related request (when resolvable).' },
  { key: 'support',          description: 'Applicant support address shown on the external materials upload page (first address is displayed)' },
];
