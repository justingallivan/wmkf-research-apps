 ...
 * @returns {Promise<{ ok: true } | { ok: false, reason: 'misconfigured'|'not_found'|'read_failed'|'removed'|'ineligible'|'token_revoked'|'token_not_minted'|'token_invalid_data'|'token_expired'|'token_insufficient_window'|'due_date_missing'|'conflict'|'prepare_failed'|'send_failed', errors?: any[] }>}
 */
