 ...
 * Assessment) must not silently substitute ProjectDescription.pdf when the
 * canonical Phase II proposal is absent. Reviewer Finder owns its separate,
 * exact current-cycle fallback in reviewer-finder/load-proposal-service.js.
 *
