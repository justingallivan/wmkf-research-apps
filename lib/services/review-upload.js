 ...
 *      filename, received-at, Review Received lifecycle status, picklists,
 *      affiliation, staff flag).
 *
...
// Extracted to reviewer-subfolder.js (slice 6c-ii Stage C) so a caller that
// only needs this pure function (the Test Request Factory) does not have to
// import this file's full dependency graph. Re-exported unchanged so every
// existing importer of `buildReviewerSubfolder` from here keeps working.
export { buildReviewerSubfolder };
