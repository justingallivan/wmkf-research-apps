...
// the require argument is a variable, defeating static import tracers, same
// pattern as loadEnvLocal's fs/path loads. Cached module-locally after the
// first call; a load failure (e.g. this file required in a browser bundle
// where request-correlation.js's own guards still make it safe, or any
// unexpected error) is swallowed and observability is treated as absent.
