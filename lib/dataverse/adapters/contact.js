...
// ────── Institution lookup (alert-reviewer-affiliation-mismatch) ──────────
// Deliberately narrower select than FIELD_SELECT — this caller only needs the
// institution-comparison fields, not the full canonical contact projection.
