 ...
 * expertise, whyChosen }; only present keys are written. Affiliation writes to the
 * canonical wmkf_primaryaffiliation (clamped to its 500 column cap) AND a clamped
 * copy to the legacy wmkf_organizationname (100) compat shadow (S213 D-AFF).
 */
