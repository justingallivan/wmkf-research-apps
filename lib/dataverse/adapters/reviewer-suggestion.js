...
const MERGE_PREDICATE_SELECT = [
  ...
  'wmkf_reviewdueextensiongrantedat',
...
const ENGAGEMENT_STAMP_RESET_ENTRIES = Object.freeze([
  ...
  ['wmkf_reviewdueextensiongrantedat', 'reviewDueDateExtensionGrantedAt', null],
...
export async function updateLifecycle(id, updates, { actingUserSystemId, ifMatch } = {}) {
  ...
  const map = {
    ...
    reviewDueDateExtensionGrantedAt: 'wmkf_reviewdueextensiongrantedat',
