 ...
 *  - `queryRequests`/`queryAllRequests` are raw passthroughs to
 *    DynamicsService.queryRecords/queryAllRecords (arg-for-arg): they exist so a
 *    caller-built business filter can drop the raw DynamicsService import
 *    without the filter itself moving into the adapter.
 *
