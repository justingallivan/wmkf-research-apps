 ...
 * DynamicsService.queryAllRecords arg-for-arg. Byte-mirror of
 * pages/api/cron/grantee-deliverable-reminders.js's inline day-12 scan
 * (`select`/`filter`/`orderby`, any subset).
 *
 ...
 */
export async function queryAllDeliverables(options) {
