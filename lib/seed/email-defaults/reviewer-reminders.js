...
export const REVIEWER_REMINDER_REVIEW_DUE_SEED_BODY =
  ...
  'Please continue using the secure link in your original review materials email. If you no longer have that ' +
  'email, contact the Foundation for a replacement link. If you have already submitted, thank you — no further action is needed.\n\n' +
