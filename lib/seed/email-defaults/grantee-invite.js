export const GRANTEE_INVITE_SEED_SUBJECT =
  'Your W. M. Keck Foundation award — abstract for our website';

export const GRANTEE_INVITE_SEED_BODY =
  'Dear Professor {{granteeName}},\n\n' +
  'Congratulations on your recent grant from the W. M. Keck Foundation. We plan to ' +
  'post an abstract on the Foundation’s website describing your award entitled “{{proposalTitle}}”.\n\n' +
  ...
  'use the secure link below to review it and make any changes no later than COB {{dueDate}}. ' +
