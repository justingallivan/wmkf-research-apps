...
try {
  ...
  console.log('     There is no manual re-invite button. Automatic reviewer reminders are paused, and live token-issuing resends are frozen during the incident hold.');
