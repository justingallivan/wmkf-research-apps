...
- **Still-open structural questions from S195/S196** (don't re-litigate the frame, but these feed the mockups): 4-tab (Find/Invite/Track/Closeout) vs 3-tab (Find/Roster/Closeout) for the reviewer slice; PD dashboard row content; closeout status field name owed to Connor.
