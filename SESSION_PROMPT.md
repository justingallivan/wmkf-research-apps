...
- **Reviewer tab structure: DECIDED S206 — 3-tab** (Find / Roster / Closeout), default landing Roster. The 4-tab alternative was rejected. Still-open structural questions that feed the mockups: PD dashboard row content; closeout status field name owed to Connor.
