/**
 * `/meeting-tracker/sessions` has no index of its own: the dashboard at
 * `/meeting-tracker` lists sessions and links to each `/sessions/<id>`. A trimmed
...
export default function MeetingTrackerSessionsIndexRedirect() {
  return null;
}
