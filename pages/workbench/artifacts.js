 ...
 * (`/workbench?view=initial-assessments`). Redirect, carrying the cycle so old
...
export async function getServerSideProps({ query }) {
  ...
  return {
    redirect: { destination: buildWorkbenchHref({ ...state, view: 'initial-assessments' }), permanent: false },
  };
}
