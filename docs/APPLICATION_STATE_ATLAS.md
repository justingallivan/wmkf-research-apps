...
| Reviewer identity resolver observability | `reviewer_identity_shadow_log` (best-effort legacy/works/combined comparison log; migration 026 **not yet applied** to the live database) | [postgres-reviewer-identity-shadow-log.md](atlas/postgres-reviewer-identity-shadow-log.md) |
