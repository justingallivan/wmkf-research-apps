...
| Pre-Site informational distribution | `pre_site_distribution_attempts` (exact preview, cross-system send recovery, transport receipt; no attachment bytes) — **[VERIFIED LIVE 2026-08-23 via migration/schema readback; 55 columns, canonical constraints/indexes, zero rows]** | [postgres-infra-tables.md](atlas/postgres-infra-tables.md) |
