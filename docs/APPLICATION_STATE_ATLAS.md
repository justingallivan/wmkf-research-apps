...
| `wmkf_deliberationsession` | sandbox row census not probed; Production entity absent/unverified | **[SANDBOX SCHEMA EXACT 2026-09-09; SOURCE-BUILT 2026-09-10.]** Wave 28 is 22 exact / 0 absent / 0 divergent in sandbox. The `codex/meeting-tracker` branch supplies readiness-gated, grant-protected session CRUD, explicit actor attribution, reference-only attendees, and the Meeting Tracker pages. The readiness flag remains unset and Production is unapplied. | [dataverse-wmkf-deliberationsession.md](atlas/dataverse-wmkf-deliberationsession.md) |
| `wmkf_deliberationslot` | sandbox row census not probed; Production entity absent/unverified | **[SANDBOX SCHEMA EXACT 2026-09-09; SOURCE-BUILT 2026-09-10.]** Wave 28 is 22 exact / 0 absent / 0 divergent in sandbox. The `codex/meeting-tracker` branch supplies ETag-fenced add/edit/move/delete operations, atomic full-order changesets, the ordered session UI, and the fixed fail-open batched schedule reader. The readiness flag remains unset and Production is unapplied. | [dataverse-wmkf-deliberationslot.md](atlas/dataverse-wmkf-deliberationslot.md) |
...
| Meeting Tracker session agenda | `deliberation_agenda_sends` (exact email snapshot, send lease, Dynamics activity/transport receipt, one unresolved send per session, terminal failed-attempt audit) — **[SOURCE-BUILT 2026-09-10; migration 041 NOT APPLIED BY CODEX]** | [postgres-infra-tables.md](atlas/postgres-infra-tables.md) |
