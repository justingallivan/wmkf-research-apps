...
| Reviewer institution measurement | `reviewer_institution_measurement_events` — **[SOURCE-BUILT 2026-09-14; migration 048 NOT APPLIED BY CODEX; flag defaults off]** pseudonymous, non-authoritative Find roster/staff/save observations with 90-day retention and a row cap | [postgres-reviewer-institution-measurement-events.md](atlas/postgres-reviewer-institution-measurement-events.md) |
