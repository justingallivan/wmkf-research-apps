...
| Consultant Feedback (slice 1) | `consultant_feedback` (staff-recorded informal consultant feedback on a proposal, attributed to a roster consultant or a one-off name stored on the entry, shared on the briefing page by default) — **[SOURCE-BUILT 2026-09-14: migration 048 in source, fresh-install v50; no Dataverse schema change, no attachments (slice 2)]** | [postgres-infra-tables.md](atlas/postgres-infra-tables.md) |
