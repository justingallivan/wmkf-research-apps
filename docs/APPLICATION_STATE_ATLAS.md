...
| Meeting Tracker session agenda | `deliberation_agenda_sends` (exact email snapshot, send lease, Dynamics activity/transport receipt, separate unresolved-send recovery) — **[SOURCE-BUILT 2026-09-10; migration 041 NOT APPLIED BY CODEX]** | [postgres-infra-tables.md](atlas/postgres-infra-tables.md) |
