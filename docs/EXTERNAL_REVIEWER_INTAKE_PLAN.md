...
> **Current routing:** Historical architectural reference for the shipped external-reviewer intake scope. Use the live external routes and their source contracts for changes.
