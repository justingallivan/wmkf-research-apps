...
**Materials hold rule:** until a duplicate-recipient guard ships, do not re-send Materials to any reviewer whose status already shows materials sent or under review. When a newly accepted reviewer needs materials, send only to that unsent reviewer after confirming all prior materials recipients are unselected; if the recipient list cannot establish that safely, do not send.
