...
|---|---|---|
| Generic uploader creates public Blob artifacts for sensitive document workflows | `docs/security-audit/SECURITY_AUDIT_2026-06-11.md` P2 | Pilot done (2026-06-11) — `expense-reporter` uploads private + reads server-side via `lib/utils/uploaded-blob.js`; live smoke + ~14 remaining consumers + download proxy + `file-loader` still open. See `PHASE_1_PRIVATE_BLOB_DESIGN_2026-06-11.md` |
