...
| AI proposal processing | Claude integration across [13](CANONICAL_COUNTS.md#app-definition-count) apps | Working |
...
readback proved the stored v1 setting also contained a six-person Southern
California audience. The 2026-09-01 UTC v2 migration preserved both audiences
exactly. The reviewed persona
