...
- Review DOCX template implementation: **[PRODUCTION-LIVE + SIGNED-IN EXPORT
  ...
  `invalid_snapshot`; its bounded error scan was empty. The Wave 3 backfill is
