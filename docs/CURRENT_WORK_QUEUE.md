...
- Review DOCX template implementation: **[PRODUCTION-LIVE + SIGNED-IN EXPORT
  ...
  old legacy-path item retained. Owner Word Online visual confirmation of
  version `3.0`, a fresh v4 population manifest, remaining writes, old-file cleanup,
