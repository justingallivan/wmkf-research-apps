...
- Pre-Site durable-generation production proof: commit `abfe5529` reached Ready
  ...
  v3 is implemented and locally verified with an
  explicit no-wrap label; production promotion and the signed-in Word Online
  v3 smoke remain open. The same pending promotion includes the compact
