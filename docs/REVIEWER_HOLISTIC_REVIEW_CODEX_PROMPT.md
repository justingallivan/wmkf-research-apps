---
title: Reviewer Finding & Disambiguation — Holistic Review Prompt (for CODEX)
domain: reviewer-identity
kind: audit
status: draft
summary: "Pointer-based prompt for a CODEX session to holistically reassess reviewer finding and disambiguation — reframe-first, full latitude, curated reading map."
canonical: false
...
# Holistic review request — reviewer finding & disambiguation (for CODEX)
...
Write your analysis to a new file **`outputs/reviewer-holistic-review-CODEX-findings.md`**
