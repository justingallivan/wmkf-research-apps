...
- Fix: add `wmkf_reviewdueextensiongrantedat`, write/clear it atomically with the override, project it through reviewer reads, and render a dated “Review due date extended” history event.
