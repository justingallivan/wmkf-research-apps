...
| D1 | Pre-existing: sites trust the body without checking `ok` (census: 38 unwrapped JSON candidates, heuristic, to be confirmed by reading) | Preserved during migration. Stage 5a/5b and the scoped remainder are released through `8623c2f7b`; see `docs/plans/CLIENT_REQUEST_LAYER_D1_UNGUARDED_RESPONSES_2026-09-20.md` for accepted implementation evidence. Release evidence: `docs/plans/AGENDA_D1_RELEASE_2026-09-20.md`. |
