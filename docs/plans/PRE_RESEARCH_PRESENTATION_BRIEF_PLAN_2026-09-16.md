...
| B2 | Referee sentences | Reuse the deterministic Reviews-tab composers (score tally + reviewer roster sentence). No new prompt. **Superseded 2026-09-21 (owner decision):** the paragraph also carries the expertise sentence — see the note under §2 (line ~94). |
