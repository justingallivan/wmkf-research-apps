...
settings-identity widening after a Codex adversarial review, `0a4eafd6` advisory test, `9a790c64`/`529ee426` 6B3b recipient-field widening after a second) is also
