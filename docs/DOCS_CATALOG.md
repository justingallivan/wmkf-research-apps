...
| [REVIEWER_FIND_BROWSER_TEST_PLAN.md](REVIEWER_FIND_BROWSER_TEST_PLAN.md) | plan | active |  | Layered, side-effect-controlled browser verification for Reviewer Find warm revisits and targeted refreshes. | 2026-08-02 |
| [REVIEWER_FIND_PERFORMANCE_PLAN.md](REVIEWER_FIND_PERFORMANCE_PLAN.md) | plan | active |  | Implementation plan for instant cached Reviewer Find revisits, narrow authoritative revalidation, and explicit cold-search behavior. | 2026-08-02 |
