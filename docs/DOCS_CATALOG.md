...
| [REVIEWER_LIFECYCLE_STAGE7_BUILD_PLAN.md](REVIEWER_LIFECYCLE_STAGE7_BUILD_PLAN.md) | plan | draft |  | Census of the 18 generic suggestion writers; six remaining moves (3F–3K, behavior-preserving); Stage 7 gate that only lets the recorded importer set shrink. | 2026-09-06 |
