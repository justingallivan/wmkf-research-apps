...
| [FINAL_WRITEUPS_DASHBOARD_CYCLE_SCOPING_PLAN.md](FINAL_WRITEUPS_DASHBOARD_CYCLE_SCOPING_PLAN.md) | plan | active |  | Plan-first contract for scoping the Final writeups dashboard read model to one grant cycle before the global 100-row bound fails the page; not built. | 2026-09-06 |
