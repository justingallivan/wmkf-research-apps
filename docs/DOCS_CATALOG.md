...
| [DATAVERSE_SHAREPOINT_FILE_MODEL.md](DATAVERSE_SHAREPOINT_FILE_MODEL.md) | source-of-truth | active | yes | File storage and linking in AkoyaGO/Dynamics, including the governed SharePoint/Dataverse contract for editable staff writeups. | 2026-07-02 |
