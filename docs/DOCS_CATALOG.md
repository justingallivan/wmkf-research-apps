...
| [INSTITUTION_PAIR_CONSISTENCY_RESOLUTION_PLAN.md](INSTITUTION_PAIR_CONSISTENCY_RESOLUTION_PLAN.md) | plan | active |  | The source-aware conditional-neutrality contract passes its 25-case shadow gate; production still uses the incumbent boolean contract. | 2026-08-08 |
