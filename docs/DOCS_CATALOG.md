...
| File | Kind | Status | Canonical | Summary | Cataloged |
|---|---|---|---|---|---|
| [PROMPT_CACHING_AUDIT.md](PROMPT_CACHING_AUDIT.md) | plan | active |  | July 2026 cache audit: R1/R3/R4 shipped; 2026-09-20 run-row telemetry confirms pre-fix write-no-read, post-fix read pending; R5 and panel user turn data-gated. | 2026-09-20 |
...
| [INSTITUTION_PAIR_CONSISTENCY_RESOLUTION_PLAN.md](INSTITUTION_PAIR_CONSISTENCY_RESOLUTION_PLAN.md) | plan | active |  | Stage 2 presentation is live; Stage 3 measurement storage is applied and empty while prospective capture remains disabled. | 2026-08-08 |
...
| [PC_MEETING_TRACKER_PLAN.md](PC_MEETING_TRACKER_PLAN.md) | plan | active |  | Production-live PC app for deliberation sessions, proposal slots, site visits, and agenda email preparation; Wave 28 is exact and the readiness flag is on. | 2026-09-09 |
