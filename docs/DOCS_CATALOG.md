...
| [INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md](INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md) | audit | active |  | Request 1003109 production-proves canonical input, linked run, exact reuse, and recovery; human editing and library controls remain. | 2026-07-30 |
...
| [REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md](REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md) | plan | canonical | yes | Initial Assessment canonical input, new-run lineage, and interrupted-finalization recovery are proven; substantive editing and library controls remain. | 2026-07-26 |
