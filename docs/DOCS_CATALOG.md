...
| [REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md](REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md) | plan | canonical | yes | Review synthesis lifecycle is deployed with automation disabled; signed-in verification and bounded enablement smoke precede further Workbench work. | 2026-07-26 |
...
| [DATAVERSE_SHAREPOINT_FILE_MODEL.md](DATAVERSE_SHAREPOINT_FILE_MODEL.md) | source-of-truth | active | yes | File storage and linking in AkoyaGO/Dynamics, including the retained reviewer-upload path; current reviews use structured Dataverse answers. | 2026-07-02 |
