...
| [REVIEWER_IDENTITY_CONTACT_PLAN.md](REVIEWER_IDENTITY_CONTACT_PLAN.md) | plan | active |  | Active roadmap: structured scholarly email and its narrow alternate tie-break are live; full-text XML and page-first fallbacks were not promoted. | 2026-07-18 |
