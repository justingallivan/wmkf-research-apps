...
| [REVIEWER_MANUAL_RESPOND_NUDGE_BUILD_PLAN.md](REVIEWER_MANUAL_RESPOND_NUDGE_BUILD_PLAN.md) | plan | active |  | Give a PD an on-demand nudge for an invited reviewer who has not answered, and close the removed-candidate hole the shipped nudge shares. | 2026-08-13 |
