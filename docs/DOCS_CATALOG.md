...
| [REVIEWER_IDENTITY_CONTACT_HANDOFF.md](REVIEWER_IDENTITY_CONTACT_HANDOFF.md) | runbook | active |  | Continuation handoff: W0 and W1 affiliation/COI are implemented; promotion verification is next, while W2-W4 remain gated. | 2026-07-18 |
| [REVIEWER_IDENTITY_CONTACT_PLAN.md](REVIEWER_IDENTITY_CONTACT_PLAN.md) | plan | active |  | W0/W1 institution and COI corrections plus three email improvements are live; disambiguation, broader alternates, and durable identity remain gated. | 2026-07-18 |
