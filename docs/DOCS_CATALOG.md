...
| [INSTITUTION_RESOLUTION_OFFLINE_EVALUATION_PLAN.md](INSTITUTION_RESOLUTION_OFFLINE_EVALUATION_PLAN.md) | plan | draft |  | Offline institution-resolution readiness plan using private cycle evidence, deterministic replay, live canaries, and bounded workload tests. | 2026-08-07 |
