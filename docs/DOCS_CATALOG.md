...
| [REVIEWER_CONTACT_PROMOTION_AND_ADDRESS_LIFECYCLE.md](REVIEWER_CONTACT_PROMOTION_AND_ADDRESS_LIFECYCLE.md) | plan | active |  | Problem statement only — nothing here is built. Five linked defects in how a reviewer address earns trust, becomes a canonical contact, and ages. | 2026-07-30 |
