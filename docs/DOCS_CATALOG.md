...
| [CLAUDE_INSTRUCTION_AUTHORITY.md](CLAUDE_INSTRUCTION_AUTHORITY.md) | source-of-truth | canonical | yes | Status: Active Last verified: 2026-08-14 Purpose: Identify the authoritative definition and enforcement mirror for must-follow agent instructions. | 2026-07-02 |
...
| [INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md](INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md) | audit | active |  | Request 1003109 proves the core pilot; native version and first-stage recovery pass while administrative controls remain. | 2026-07-30 |
...
| [REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md](REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md) | plan | canonical | yes | Initial Assessment core flow, native version restore, and first-stage recovery are proven; administrative and milestone controls remain. | 2026-07-26 |
...
| [PRE_SITE_VISIT_DATAVERSE_SCHEMA_DESIGN.md](PRE_SITE_VISIT_DATAVERSE_SCHEMA_DESIGN.md) | spec | active |  | Production-live Wave 19 schema, production-proved Pre-Site writer, and deployed Site Visit handoff contract. | 2026-08-17 |
...
| [MEMORY_ROUTER_EARLY_WARNING_PLAN.md](MEMORY_ROUTER_EARLY_WARNING_PLAN.md) | plan | draft |  | Owner-approved design for an 8 KiB router early-warning notice across the checker, SessionStart/Stop hooks, and start/stop skills; pre-build review pending. | 2026-08-21 |
...
| [REVIEWER_MANUAL_RESPOND_NUDGE_BUILD_PLAN.md](REVIEWER_MANUAL_RESPOND_NUDGE_BUILD_PLAN.md) | plan | active |  | Give PDs an on-demand nudge for unanswered reviewers while blocking removed/revoked token resurrection. | 2026-08-13 |
...
| File | Kind | Status | Canonical | Summary | Cataloged |
|---|---|---|---|---|---|
| [WORKBENCH_WRITEUP_LIFECYCLE_PLAN.md](WORKBENCH_WRITEUP_LIFECYCLE_PLAN.md) | plan | active |  | Cross-tab design for the Pre-Site Word workspace, Site Visit dossier, and Final Writeup lineage. | 2026-08-17 |
