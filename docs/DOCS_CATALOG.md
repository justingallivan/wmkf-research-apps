...
| [INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md](INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md) | audit | active |  | Request 1002788 preserves mechanics-only evidence; Request 1003109 proves canonical input, new-run lineage, and exact reuse; recovery/editing remain. | 2026-07-30 |
...
| [REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md](REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md) | plan | canonical | yes | Initial Assessment canonical input and new-run lineage are proven; recovery, substantive editing, and library controls remain. | 2026-07-26 |
