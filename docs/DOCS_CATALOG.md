...
| [REVIEWER_IDENTITY_CONTACT_PLAN.md](REVIEWER_IDENTITY_CONTACT_PLAN.md) | plan | active |  | Structured scholarly email, a narrow alternate tie-break, and reviewer-owned preferred-email attestation are live; other fallbacks were not promoted. | 2026-07-18 |
