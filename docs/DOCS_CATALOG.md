...
| [INSTITUTION_RESOLUTION_OFFLINE_EVALUATION_PLAN.md](INSTITUTION_RESOLUTION_OFFLINE_EVALUATION_PLAN.md) | plan | active |  | Offline institution-resolution readiness plan using private cycle evidence, deterministic replay, live canaries, and bounded workload tests. | 2026-08-07 |
...
| [REVIEWER_IDENTITY_AND_INSTITUTION_RESOLUTION_RESEARCH.md](REVIEWER_IDENTITY_AND_INSTITUTION_RESOLUTION_RESEARCH.md) | decision | active |  | Research foundation for reviewer identity and institution resolution; current build authority lives in the Codex handoff. | 2026-08-04 |
