...
| [DYNAMICS_SERVICE_DECOMPOSITION_PLAN.md](DYNAMICS_SERVICE_DECOMPOSITION_PLAN.md) | plan | draft | yes | PLANNED: DynamicsService (1,728 L Dataverse WRITE hub) → lib/services/dynamics/*.js behind a thin facade; behavior-freeze, DAL guards + 5 LAW gates preserved. |  |
