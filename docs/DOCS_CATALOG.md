...
| [REVIEWER_TERMINAL_STATUS_AND_DUE_DATE_PLAN.md](REVIEWER_TERMINAL_STATUS_AND_DUE_DATE_PLAN.md) | plan | active |  | Terminal post-accept reviewer statuses (withdrew / released) plus a due date stamped at send, so reviewer reliability is measurable. | 2026-07-22 |
