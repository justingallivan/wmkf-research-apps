...
| [INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md](INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md) | audit | active |  | Request 1002788 mechanics evidence, invalid Phase II input evidence, and deployed recovery/run-linkage fixes; a canonical-input pilot remains open. | 2026-07-30 |
...
| [REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md](REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md) | plan | canonical | yes | Initial Assessment mechanics are proven, but canonical-proposal content proof, recovery re-proof, substantive editing, and library controls remain. | 2026-07-26 |
