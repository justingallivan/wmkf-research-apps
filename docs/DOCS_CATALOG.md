...
| [ODATA_ESCAPE_CONSOLIDATION_PLAN.md](ODATA_ESCAPE_CONSOLIDATION_PLAN.md) | plan | draft | yes | Consolidate hand-rolled OData quote escaping onto canonical odata.escape; 10 same-semantics sites swap mechanically, 2 divergent sites STOP-AND-ASK. | 2026-07-05 |
