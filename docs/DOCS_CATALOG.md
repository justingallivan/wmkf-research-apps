...
| [REVIEWER_IDENTITY_CONTACT_HANDOFF.md](REVIEWER_IDENTITY_CONTACT_HANDOFF.md) | runbook | active |  | Continuation handoff: W0/W1 are live and W2 has a legacy-default runtime seam; authoritative cutover remains owner-gated. | 2026-07-19 |
| [REVIEWER_IDENTITY_CONTACT_PLAN.md](REVIEWER_IDENTITY_CONTACT_PLAN.md) | plan | active |  | W0/W1 and three email improvements are live; W2 has a legacy-default runtime seam, while authoritative cutover and durable identity remain gated. | 2026-07-19 |
...
| [REVIEWER_IDENTITY_SHADOW_LOGGER_HANDOFF.md](REVIEWER_IDENTITY_SHADOW_LOGGER_HANDOFF.md) | runbook | active |  | Durable Postgres shadow-comparison logger; runtime-seam ownership returns to Codex; migration 026 deliberately not applied. | 2026-07-19 |
