...
| [REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md](REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md) | plan | canonical | yes | Review synthesis lifecycle is production-proved with automation enabled; the next sequence is the remaining Workbench lifecycle design freeze. | 2026-07-26 |
...
| [GRANTEE_SUBMIT_VISIBILITY_SPEC.md](GRANTEE_SUBMIT_VISIBILITY_SPEC.md) | spec | draft |  | Proposed: a best-effort submit notification to the assigned PD, plus caption and image visibility on the staff Awardee tab. | 2026-07-29 |
