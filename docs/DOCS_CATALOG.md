...
| [REVIEWER_IDENTITY_SHADOW_LOGGER_HANDOFF.md](REVIEWER_IDENTITY_SHADOW_LOGGER_HANDOFF.md) | runbook | active |  | Durable Postgres resolver-comparison logger integrated into the Codex W2/W4 branch; migration 026 deliberately not applied. | 2026-07-19 |
