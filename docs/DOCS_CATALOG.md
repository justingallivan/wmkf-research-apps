...
| [J27_SINGLE_PHASE_TRANSITION_INVENTORY_PLAN.md](J27_SINGLE_PHASE_TRANSITION_INVENTORY_PLAN.md) | plan | active |  | Plan for agents to sweep code, docs, and memory into one register of what retires, persists, changes, or must be built for the June 2027 single-phase cycle. | 2026-09-06 |
| [J27_TRANSITION_REGISTER.md](J27_TRANSITION_REGISTER.md) | source-of-truth | active | yes | Living register of every J27-sensitive site in code, docs, and memory: what retires, persists, changes, or must be built for the June 2027 single-phase cycle. | 2026-09-06 |
...
| [REVIEWER_COMPLETION_AND_HONORARIUM_DECISION_BRIEF.md](REVIEWER_COMPLETION_AND_HONORARIUM_DECISION_BRIEF.md) | plan | active |  | Approved contract separating review receipt, thank-you, PD closeout and honorarium eligibility, and final authorization to remit. | 2026-09-03 |
...
| [REVIEWER_LIFECYCLE_STAGE2_BUILD_PLAN.md](REVIEWER_LIFECYCLE_STAGE2_BUILD_PLAN.md) | plan | active |  | One browser-safe policy module for the duplicated correction-source and closed-engagement status sets; callers keep their error identities; no new values. | 2026-09-05 |
| [REVIEWER_LIFECYCLE_STAGE3_BUILD_PLAN.md](REVIEWER_LIFECYCLE_STAGE3_BUILD_PLAN.md) | plan | historical |  | Shipped 2026-09-05/06 (3A–3E, PRs #154–#161). Named lifecycle commands live in lib/services/reviewer-engagement/; expansion 3F–3K is in the Stage 7 plan. | 2026-09-06 |
| [REVIEWER_LIFECYCLE_STAGE5_BUILD_PLAN.md](REVIEWER_LIFECYCLE_STAGE5_BUILD_PLAN.md) | plan | historical |  | Shipped 2026-09-05 (PR #157). Two ETag-required adapter ops replace the generic receipt passthrough at the pointer and thank-you sites; 5B skipped. | 2026-09-05 |
| [REVIEWER_LIFECYCLE_STAGE6B_BUILD_PLAN.md](REVIEWER_LIFECYCLE_STAGE6B_BUILD_PLAN.md) | plan | active |  | Sequential in-place action lifetime fixes; 6B1–6B3 promoted to main (600cc972) 2026-09-05; 6C (PR #153) and 6D (PR #159) followed and are complete. | 2026-09-05 |
| [REVIEWER_LIFECYCLE_STAGE6C_BUILD_PLAN.md](REVIEWER_LIFECYCLE_STAGE6C_BUILD_PLAN.md) | plan | historical |  | Pure move of the materials modal, token actions menu and reminder action out of ReviewerManagePanel; re-exports preserved; no behavior change; precedes 6D. | 2026-09-05 |
| [REVIEWER_LIFECYCLE_STAGE6D_BUILD_PLAN.md](REVIEWER_LIFECYCLE_STAGE6D_BUILD_PLAN.md) | plan | historical |  | Shipped 2026-09-06 (PR #159). render-emails stamps a server-side draft fingerprint; send-emails recomputes it and refuses stale drafts as draft_stale. | 2026-09-06 |
| [REVIEWER_LIFECYCLE_STAGE7_BUILD_PLAN.md](REVIEWER_LIFECYCLE_STAGE7_BUILD_PLAN.md) | plan | historical |  | Shipped 2026-09-06 (PRs #162–#168). Slices 3F–3K, LAW boundary gate, bulkUpdateByRequest removed. D0/D3 taken, D1 preserved, D4(a) chosen, D2/D5 open. | 2026-09-06 |
...
| [WORKBENCH_REVIEWS_TAB_BUILDOUT_PLAN.md](WORKBENCH_REVIEWS_TAB_BUILDOUT_PLAN.md) | plan | active |  | Reviews, synthesis, and template-backed Word exports are Production-live; Wave 25 is exact and the combined export is signed-in smoke-proved. | 2026-07-03 |
...
| [FINAL_WRITEUP_REVIEW_IMPLEMENTATION_PLAN.md](FINAL_WRITEUP_REVIEW_IMPLEMENTATION_PLAN.md) | plan | active |  | Final runtime, staffing, lenses, 6A scoping, 6B views/PD filter, and 6C version context are Production-live; the leadership-review transition (Slice 4) is built and awaiting promotion. | 2026-08-28 |
...
| [WORKBENCH_WRITEUP_LIFECYCLE_PLAN.md](WORKBENCH_WRITEUP_LIFECYCLE_PLAN.md) | plan | active |  | Pre-Site/Site Visit lifecycle, Final acknowledgement/dashboard, and explicit persona lenses are live; the Final leadership-review transition is built and awaiting promotion. | 2026-08-17 |
