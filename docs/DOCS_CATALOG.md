...
| [INSTITUTION_PAIR_CONSISTENCY_RESOLUTION_PLAN.md](INSTITUTION_PAIR_CONSISTENCY_RESOLUTION_PLAN.md) | plan | active |  | Stage 2 source-aware notifications and reviewer-card explanations are implemented behind a default-off flag; boolean identity and write authority is unchanged. | 2026-08-08 |
