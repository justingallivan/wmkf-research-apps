...
| [REVIEWER_IDENTITY_CONTACT_PLAN.md](REVIEWER_IDENTITY_CONTACT_PLAN.md) | plan | active |  | Active roadmap: structured scholarly email is live; full-text XML and page-first fallbacks were not promoted; remaining work is eval- and owner-gated. | 2026-07-18 |
