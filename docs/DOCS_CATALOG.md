...
| [PRE_SITE_VISIT_DATAVERSE_SCHEMA_DESIGN.md](PRE_SITE_VISIT_DATAVERSE_SCHEMA_DESIGN.md) | spec | active |  | Production-live Wave 19 schema and locally implemented writer contract for governed Pre-Site drafts and current Pre-Site/Final Request pointers. | 2026-08-17 |
...
| [INSTITUTION_PAIR_CONSISTENCY_RESOLUTION_PLAN.md](INSTITUTION_PAIR_CONSISTENCY_RESOLUTION_PLAN.md) | plan | active |  | Staged plan to auto-resolve manufactured institution conflicts. Stage 1 landed (alert + enrichment, Wave 6 2026-08-09); Stages 2-3 not yet built. | 2026-08-08 |
...
| File | Kind | Status | Canonical | Summary | Cataloged |
|---|---|---|---|---|---|
| [WORKBENCH_WRITEUP_LIFECYCLE_PLAN.md](WORKBENCH_WRITEUP_LIFECYCLE_PLAN.md) | plan | draft |  | Cross-tab design for the Pre-Site Word workspace, Site Visit dossier, and Final Writeup lineage. | 2026-08-17 |
