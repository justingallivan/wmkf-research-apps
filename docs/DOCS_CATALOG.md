...
| [REVIEWER_EMAIL_CONFLICT_SELF_SERVICE_PLAN.md](REVIEWER_EMAIL_CONFLICT_SELF_SERVICE_PLAN.md) | plan | active |  | Plan to replace the reviewer Admin-alert loop with a Workbench stored-versus-found email choice guarded by fresh reads and an audited staff decision. | 2026-08-20 |
