...
| [INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md](INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md) | audit | active |  | Request 1002788 pilot evidence and the tested source fixes for recovery hashing and future AI-run request linkage; production re-proof remains open. | 2026-07-30 |
...
| [REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md](REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md) | plan | canonical | yes | Initial Assessment fixes are source-tested; production recovery/run-linkage proof, substantive editing, and library controls remain. | 2026-07-26 |
