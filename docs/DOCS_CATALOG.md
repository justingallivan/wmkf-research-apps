...
| [INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md](INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md) | audit | active |  | Request 1003109 proves the core pilot; administrator restore and exact byte-copy Board controls are source-built and await promotion/write proof. | 2026-07-30 |
...
| [REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md](REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md) | plan | canonical | yes | Initial Assessment core flow is proven; administrator restore and byte-copy Board controls are source-built and await promotion/write proof. | 2026-07-26 |
