...
| [REVIEWER_IDENTITY_CONTACT_HANDOFF.md](REVIEWER_IDENTITY_CONTACT_HANDOFF.md) | runbook | active |  | Paste-ready Codex handoff for the Reviewer Identity & Contact plan; scopes the first build to W0+W1 (affiliation/COI), W2-W4 held behind owner gates. | 2026-07-18 |
| [REVIEWER_IDENTITY_CONTACT_PLAN.md](REVIEWER_IDENTITY_CONTACT_PLAN.md) | plan | draft |  | DRAFT/no-build roadmap for reviewer disambiguation, affiliation/COI matching, and email discovery — sequenced and owner-gated; nothing built. | 2026-07-18 |
...
| [REVIEWER_PAGE_FIRST_EMAIL_EXPERIMENT_PLAN.md](REVIEWER_PAGE_FIRST_EMAIL_EXPERIMENT_PLAN.md) | plan | draft |  | Staged read-only test of anchored Google page discovery for invitation-ready reviewer emails, capped to minimize manual verification. | 2026-07-18 |
