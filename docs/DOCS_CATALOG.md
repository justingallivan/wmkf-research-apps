...
| [INSTITUTION_PAIR_CONSISTENCY_RESOLUTION_PLAN.md](INSTITUTION_PAIR_CONSISTENCY_RESOLUTION_PLAN.md) | plan | active |  | Stage 1 boolean comparison is shipped; the accepted next phase replaces pair-sameness with source-aware organization relationships and conditional neutrality. | 2026-08-08 |
