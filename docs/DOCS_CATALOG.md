...
| [INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md](INITIAL_ASSESSMENT_CONTROLLED_PILOT_2026-07-30.md) | audit | active |  | Request 1002788 pilot evidence: generation, consumers, and retry passed; recovery hashing and AI-run request linkage remain open. | 2026-07-30 |
...
| [REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md](REQUEST_WORKBENCH_NEAR_TERM_EXECUTION_PLAN.md) | plan | canonical | yes | Initial Assessment pilot partially passed; recovery hashing, run linkage, substantive editing, and library controls remain. | 2026-07-26 |
