...
| [REVIEW_FORM_MULTISELECT_BUILD_PLAN.md](REVIEW_FORM_MULTISELECT_BUILD_PLAN.md) | plan | active |  | Add a multiselect question type and re-author the review question set from the owner's reworked form, expand-first with rehearsal before activation. | 2026-07-25 |
