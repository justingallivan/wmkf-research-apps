...
| [REVIEWER_REMINDER_TOKEN_LIVENESS_PLAN.md](REVIEWER_REMINDER_TOKEN_LIVENESS_PLAN.md) | plan | draft |  | Fail-closed review-due reminder token checks, staff guidance, and a read-only audit before lifting the manual-send freeze. | 2026-09-01 |
