...
| [REVIEWER_LIFECYCLE_STAGE6C_BUILD_PLAN.md](REVIEWER_LIFECYCLE_STAGE6C_BUILD_PLAN.md) | plan | active |  | Pure move of the materials modal, token actions menu and reminder action out of ReviewerManagePanel; re-exports preserved; no behavior change; precedes 6D. | 2026-09-05 |
