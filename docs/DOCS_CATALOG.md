...
| [REVIEWER_IDENTITY_AND_INSTITUTION_RESOLUTION_RESEARCH.md](REVIEWER_IDENTITY_AND_INSTITUTION_RESOLUTION_RESEARCH.md) | decision | active |  | Research-only strategy for institution resolution, reviewer identity, current affiliation, and contact attribution; no build is authorized. | 2026-08-04 |
