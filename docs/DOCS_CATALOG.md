...
| File | Kind | Status | Canonical | Summary | Cataloged |
|---|---|---|---|---|---|
| [REVIEWER_BINDING_SMOKE_CODEX_HANDOFF.md](REVIEWER_BINDING_SMOKE_CODEX_HANDOFF.md) | audit | active |  | Wave 13 binding production smoke follow-up: all four adversarial rounds resolved on PR #60, verification green, and only explicit owner-run gates remain. | 2026-07-13 |
...
| [REVIEWER_IDENTITY_BINDING_PRODUCTION_SMOKE_ADVERSARIAL_REVIEW_HANDOFF.md](REVIEWER_IDENTITY_BINDING_PRODUCTION_SMOKE_ADVERSARIAL_REVIEW_HANDOFF.md) | audit | active |  | Read-only Claude review brief for the deployed first binding-writer caller and the production-touching PR4 smoke-test candidate. | 2026-07-13 |
