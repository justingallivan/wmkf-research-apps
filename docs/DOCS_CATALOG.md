...
| File | Kind | Status | Canonical | Summary | Cataloged |
|---|---|---|---|---|---|
| [REVIEWER_BINDING_SMOKE_CODEX_HANDOFF.md](REVIEWER_BINDING_SMOKE_CODEX_HANDOFF.md) | audit | active |  | Closing handoff for the Wave 13 binding production smoke: shipped F1 fix, PR #60 state, two open adversarial-review findings, and residual owner gates. | 2026-07-13 |
