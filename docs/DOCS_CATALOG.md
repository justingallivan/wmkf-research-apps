...
| [REVIEWER_IDENTITY_CONTACT_HANDOFF.md](REVIEWER_IDENTITY_CONTACT_HANDOFF.md) | runbook | active |  | Paste-ready continuation handoff: W0 is implemented and inert; W1 affiliation/COI remains the first behavioral build, with W2-W4 gated. | 2026-07-18 |
| [REVIEWER_IDENTITY_CONTACT_PLAN.md](REVIEWER_IDENTITY_CONTACT_PLAN.md) | plan | active |  | The inert institution substrate and three email improvements are live; COI, disambiguation, broader alternates, and durable identity remain gated. | 2026-07-18 |
