...
| [INSTITUTION_PAIR_CONSISTENCY_RESOLUTION_PLAN.md](INSTITUTION_PAIR_CONSISTENCY_RESOLUTION_PLAN.md) | plan | active |  | Staged plan to auto-resolve manufactured institution conflicts so staff adjudicate only genuine mismatches. Proposed; awaiting owner approval. | 2026-08-08 |
