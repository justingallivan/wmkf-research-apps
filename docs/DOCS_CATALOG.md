...
| [DISCOVERY_SERVICE_DECOMPOSITION_PLAN.md](DISCOVERY_SERVICE_DECOMPOSITION_PLAN.md) | plan | draft | yes | Decompose the 2,348-line DiscoveryService god-class into cohesive lib/services/discovery/*.js modules behind a thin delegating facade. Behavior-freeze. |  |
