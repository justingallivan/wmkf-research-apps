...
| [FINAL_WRITEUPS_DASHBOARD_CYCLE_SCOPING_PLAN.md](FINAL_WRITEUPS_DASHBOARD_CYCLE_SCOPING_PLAN.md) | plan | active |  | Contract for scoping the Final writeups dashboard read model to one grant cycle before the global row bound fails the page; reworked after Codex review. | 2026-09-06 |
