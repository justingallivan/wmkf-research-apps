...
| [REVIEWER_LIFECYCLE_STAGE5_BUILD_PLAN.md](REVIEWER_LIFECYCLE_STAGE5_BUILD_PLAN.md) | plan | active |  | Two narrow ETag-required adapter operations replace the generic receipt passthrough at the DOCX-pointer and thank-you-claim sites; optional helper skipped. | 2026-09-05 |
| [REVIEWER_LIFECYCLE_STAGE6B_BUILD_PLAN.md](REVIEWER_LIFECYCLE_STAGE6B_BUILD_PLAN.md) | plan | active |  | Sequential in-place action lifetime fixes; 6B1–6B3 reviewed, promoted to main (600cc972) and production 2026-09-05; elective stages 6C/6D are next. | 2026-09-05 |
...
| [REVIEWER_LIFECYCLE_STAGE6D_BUILD_PLAN.md](REVIEWER_LIFECYCLE_STAGE6D_BUILD_PLAN.md) | plan | draft |  | render-emails stamps each draft with a fingerprint of server-observed inputs; send-emails recomputes it and refuses stale drafts with a labelled skipped reason. | 2026-09-05 |
