...
| [HONORARIUM_PORTAL_CREATION_STRATEGY.md](HONORARIUM_PORTAL_CREATION_STRATEGY.md) | plan | active |  | Config-gated draft implementation exists; go-live awaits env flip and Connor schema/open-item decisions. | 2026-07-02 |
