...
| [CONTACT_ENRICHMENT_SERVICE_DECOMPOSITION_PLAN.md](CONTACT_ENRICHMENT_SERVICE_DECOMPOSITION_PLAN.md) | plan | draft | yes | DRAFT (S336): plan to decompose ContactEnrichmentService (1,776 L) into lib/services/contact-enrichment/*.js modules behind a thin facade. Behavior-freeze. |  |
