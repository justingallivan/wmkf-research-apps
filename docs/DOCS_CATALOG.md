...
| [PRE_SITE_VISIT_DATAVERSE_SCHEMA_DESIGN.md](PRE_SITE_VISIT_DATAVERSE_SCHEMA_DESIGN.md) | spec | active |  | Production-live Wave 19 schema and production-proved writer contract for governed Pre-Site drafts and current Pre-Site/Final Request pointers. | 2026-08-17 |
