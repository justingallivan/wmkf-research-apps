...
| [REVIEWER_LIFECYCLE_STAGE3_BUILD_PLAN.md](REVIEWER_LIFECYCLE_STAGE3_BUILD_PLAN.md) | plan | active |  | Move closeout, terminal transition, status/response correction, expire and post-send bookkeeping into lib/services/reviewer-engagement/ behind wrappers. | 2026-09-05 |
