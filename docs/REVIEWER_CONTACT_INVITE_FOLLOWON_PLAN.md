...
> behind `REVIEWER_PAGE_EMAIL_TIER_ENABLED` (code-default OFF; production explicitly enabled
> 2026-07-03). Its ownership selector was hardened 2026-07-19 with ranked mailbox classes,
> unique-best selection, and roster-visible proof. Live design:
> `docs/RESOLVED_PAGE_EMAIL_TIER_DESIGN.md`; contract #7 in
