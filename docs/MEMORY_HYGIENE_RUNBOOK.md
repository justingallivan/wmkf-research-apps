...
Trigger: router ≥ 8,192 B, or the audit flagged status-narrative lines. Target
...
- If the drift report was regenerated by mistake: `git checkout --
  docs/RECONCILIATION_REPORT.json` before committing anything else.
