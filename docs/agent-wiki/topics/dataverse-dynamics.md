...
- **Expertise roster Contact links are reference-only** **[SOURCE-BUILT
  2026-09-14; Postgres migration 050 not yet applied].** The roster keeps its
  ...
  `--actor-profile-id` and records that profile in `updated_by`.
