...
| App access, admin, API credit/security, private Blob/file proxy | [Security & Auth](topics/security-auth.md) | `docs/API_ROUTE_SECURITY_MATRIX.md`, `docs/CREDENTIALS_RUNBOOK.md`, `docs/SECURITY_OPERATING_PLAN.md` |
...
| Pre-Research Presentation Brief (deterministic Board brief, share lock, prepare-time review/drift gate, Staff Deliberations brief card) | [External Reviewer Portal](topics/external-reviewer-portal.md) § Deliberation briefing page | `docs/plans/PRE_RESEARCH_PRESENTATION_BRIEF_PLAN_2026-09-16.md`, `docs/atlas/dataverse-wmkf-requestdocument.md` § Pre-Research Presentation Brief contract, `docs/DATAVERSE_SHAREPOINT_FILE_MODEL.md` |
