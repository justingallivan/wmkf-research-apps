...
3. Should the Initial assessments view remain hidden for D26 in Production until D26 closes, or be shown read-only so PDs can preview the J27 workflow? (Answered 2026-09-08 hidden; reversed 2026-09-09: shown for D26 as a working view, not a preview — register Q3.)
