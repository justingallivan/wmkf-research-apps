...
**Phase status:** Original staff-editable-question epic complete through S305. The multiselect code expansion is deployed (`main` `5282cee8`; production `dpl_7sfTLrMafYPKp7mnYdrEVjs9HmW5`), and the sibling `wmkf_appreviewanswer.wmkf_answervalues` production schema expansion completed first on 2026-07-26. The backward-compatible `review-synthesis.generate` v2 publication also completed 2026-07-26. The prior 12-row question set remains active; target question-set publication, rehearsal, and exposure remain pending.
**Last verified:** 2026-07-26 — the legacy active set remained 12 rows at normalized version `119da525418d1d43` and raw-row SHA-256 `3803d5a98dd54abff0c25ace8b0d6116c342236a7438086068292625ff661982` before and after the separately audited synthesis-prompt publication. The entity was originally **CREATED in prod** S303 via `scripts/apply-dataverse-schema.js --target=prod --wave=9-review-questions --execute`, then seeded with the current 12 fields via `scripts/seed-review-questions.mjs --execute`. **[VERIFIED via `outputs/review-form-multiselect/prompt-publication-evidence-2026-07-26.json` plus the S303 live fetch and schema spec].**
**Live row count:** 12 active (affiliation order 0 + 11 questions), as of 2026-07-26.
