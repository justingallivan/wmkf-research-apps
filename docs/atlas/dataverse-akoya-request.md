...
> **Reviewer Follow-up picker supersession (branch-built 2026-09-02):** the
> S261 PD-scoped cycle-picker statement above is historical. The implementation
> branch derives cycles from every organization-wide meeting-dated eligible
...
> read probe returned 236 eligible rows with `capped:false`. Deployment is pending.
