...
- **Pre-deployment expand and activation gates — cleared 2026-07-26.** Wave 15 is applied, exact metadata plus entity-set select readback passed, and compatible code is live at production deployment `dpl_7sfTLrMafYPKp7mnYdrEVjs9HmW5`. The target 12-row question set is active at `347a37e820f73890`; controlled submission/readback and rollback rehearsals remain pending.
