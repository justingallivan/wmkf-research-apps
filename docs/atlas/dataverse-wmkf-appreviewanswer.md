...
- **Pre-deployment expand gate — cleared 2026-07-26.** Wave 15 is applied, exact metadata plus entity-set select readback passed, and compatible code is live at production deployment `dpl_7sfTLrMafYPKp7mnYdrEVjs9HmW5`. The prior 12-row question set remains active; `multiselect` activation is a later controlled publication/rehearsal step.
