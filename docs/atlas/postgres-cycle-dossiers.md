...
**[VERIFIED 2026-09-07 via migration 038, fresh-install shape, source files, and branch-local service reads]** These six tables are source-built on branch `codex/cycle-dossier-pilot-build`. No live migration, Blob provisioning, prompt seeding, generation, or unattended cron activation is claimed here.
