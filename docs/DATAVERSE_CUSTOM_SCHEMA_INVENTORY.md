...
production caller is live since PR #57 / `00ffb09c`: acceptance-drain
self-report with a stable acceptance event.
The immediate post-deploy production snapshot found existing rows
null/legacy-unbound;
