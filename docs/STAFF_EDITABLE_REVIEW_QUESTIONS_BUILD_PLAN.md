...
**Verdict:** Phase C ships clean; 3 P1s resolved + regression-tested (route 10 / save 17 / RTL 4); full `npm test` green except expected-red bill/discovery.
