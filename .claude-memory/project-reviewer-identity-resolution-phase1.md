...
metadata:
  ...
  status: active
  scope: reviewer
  last_verified: 2026-07-02 via code-grounded memory triage for resolver/write-gate/backprop contracts; latest live Dataverse count snapshot remains 2026-06-04
---
