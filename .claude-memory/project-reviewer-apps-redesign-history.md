---
name: project-reviewer-apps-redesign-history
description: Closed history for the Request Workbench / reviewer-apps redesign — dated release checkpoints 2026-07-29 → 2026-09-02, the S194–S206 decision chronology, locked landing-dashboard and Workbench-v1 slice definitions, and the build sequence; split out of project-reviewer-apps-redesign-direction on 2026-09-17.
metadata:
  type: project
  status: closed
  scope: reviewer
  last_verified: 2026-09-17 via split from project-reviewer-apps-redesign-direction (content moved verbatim, not re-probed)
---

## Recall Rule

Read when you need the rationale or date of a past Request Workbench decision, a dated release checkpoint, or the original Workbench-v1 slice definition. The live direction, current source-backed state, and locked architecture stay in [[project-reviewer-apps-redesign-direction]]; do not treat any checkpoint below as current state.

## Dated release checkpoints (moved verbatim 2026-09-17)
...
- **D26 (current, dual-phase) temporary patch.** D26 is the current cycle; Phase I→II flip June 22, 2026 (owner 2026-09-06; Phase II proposals due 2026-08-18) — was ~mid-June 2026 (single-submission begins J27). In the dual-phase model, Phase II = the already-winnowed set (Phase I committee advanced them), so the reviewer dashboard fits D26 **as-is** — no triage dashboard needed for D26. Plan: ship the reviewer dashboard for D26 as a fenced, throwaway-OK patch, and **populate PD dashboards before mid-June** so PDs start finding reviewers at-risk (board recommendations known early; overturns rare).
...
- **Next cycle (J27, single-submission):** the upstream triage / cycle dashboard
  (winnow up to ~300 proposals arriving in early December 2026, date TBD; ≈
