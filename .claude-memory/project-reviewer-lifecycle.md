...
- Per-reviewer extensions are production-live in Wave 18 as nullable `wmkf_appreviewersuggestion.wmkf_reviewduedateoverride`; the accepted-row Track Reviewers action writes through a dedicated save-first/automatic-email-and-calendar workflow. The column, admin body, and runtime were verified live on 2026-08-11 / 2026-08-12 UTC (main `8647af33`, Vercel `dpl_AbTvWvMYb5inwPnYKTK2mkrkNXZz`).
