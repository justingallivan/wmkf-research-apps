...
metadata:
  ...
  last_verified: 2026-08-28 (S467) — owner directive after the admin output-budget surface shipped
---
...
in code. Open action item: `docs/CURRENT_WORK_QUEUE.md` audit follow-ups.
