...
- Tests: `tests/unit/*-a7.test.js` (6 files — email-reviewer, expertise-finder, multi-perspective, part6-prompts, reviewer-finder, virtual-review-panel) + `tests/unit/ai-payload-boundary.test.js` + `tests/unit/forged-close.test.js` (or wherever the forge-resistance tests live).
