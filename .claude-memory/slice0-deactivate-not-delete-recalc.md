...
Do:
- For current intake work, start with `docs/agent-wiki/topics/intake-portal.md`, `docs/INTAKE_PORTAL_ITEM_6_STATUS.md`, and `lib/dataverse/schema/wave4/wmkf_proposalbudgetline.json`.
...
Ground truth for current intake work: `docs/agent-wiki/topics/intake-portal.md`, `docs/INTAKE_PORTAL_ITEM_6_STATUS.md`, `lib/dataverse/schema/wave4/wmkf_proposalbudgetline.json`. Historical detail: `INTAKE_PORTAL_DESIGN.md`, `INTAKE_PORTAL_SCHEMA_CHANGES.md`. Related: [[dataverse-export-floor-scoping]].
...
- **Historical S163 state:** slice-0 deploy was gated, narrowly, on P1-Update. That gate later closed as FAIL and routed the recompute mechanism to Option A′; see S178 status below and `docs/INTAKE_PORTAL_ITEM_6_STATUS.md`.
