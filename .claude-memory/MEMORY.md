...
- [Appresearcher collapse — EXECUTING 2026-06-02](project-appresearcher-collapse-post-pilot.md) — sidecar collapse into `wmkf_potentialreviewers` now underway (posture reversed; disposable data). Live plan `docs/APPRESEARCHER_COLLAPSE_PLAN_V2.md`, decisions locked, 5 callers (not 4). "Don't act mid-pilot" is SUPERSEDED.
