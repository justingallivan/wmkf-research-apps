...
- Reviewer address trust / remedies: ../docs/REVIEWER_ADDRESS_TRUST_AND_CONFLICT_RESOLUTION_PLAN.md; ../docs/REVIEWER_EMAIL_CONFLICT_SELF_SERVICE_PLAN.md (S391 fail-closed state machine production-live; direct stored/found Workbench choice and structural AkoyaGO retry implemented in source 2026-08-20, not deployed; one active legacy repair alert retained by read-only probe.)
