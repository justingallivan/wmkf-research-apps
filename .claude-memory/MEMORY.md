...
- Reviewer address trust / remedies: ../docs/REVIEWER_ADDRESS_TRUST_AND_CONFLICT_RESOLUTION_PLAN.md (S391 source-built; second Opus review NO-SHIP on retry ORCID binding + medium gaps; Wave 17/runtime blocked.)
