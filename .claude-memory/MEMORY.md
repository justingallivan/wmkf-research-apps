...
- Reviewer enrichment fan-out / SerpAPI (LATENCY limits fan-out; value eroded — $150/mo largest expense; metrics+lit migrated to OpenAlex S251; PubPeer has NO public API → Slice 3 BLOCKED): project-serpapi-budget-latency.md; project-serpapi-capability-erosion.md; project-pubpeer-no-public-api.md
