...
- Reviewer enrichment fan-out / SerpAPI (LATENCY limits fan-out; value eroded — $150/mo; metrics+lit → OpenAlex S251; PubPeer stays on SerpAPI — no public API, parked): project-serpapi-budget-latency.md; project-serpapi-capability-erosion.md
