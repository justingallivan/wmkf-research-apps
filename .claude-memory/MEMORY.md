...
- Reviewer Find warm-reconciliation production incident / Request 1002903: ../docs/REVIEWER_FIND_WARM_RECONCILIATION_INCIDENT_2026-08-03.md (OPEN 2026-08-03; deterministic staff-action state is misclassified as retryable and the per-card refresh loop remains); ../docs/REVIEWER_FIND_PERFORMANCE_PLAN.md; ../docs/REVIEWER_WARM_STAGE_PRODUCER_SPEC.md; ../SESSION_PROMPT.md.
