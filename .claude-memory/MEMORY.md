...
- Reviewer address trust / remedies: ../docs/REVIEWER_ADDRESS_TRUST_AND_CONFLICT_RESOLUTION_PLAN.md (S391 fail-closed state machine reviewed and source-built; Wave 17/runtime blocked.)
