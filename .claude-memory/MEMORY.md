...
- Git / releases: feedback-verify-branch-before-git-action.md; project-commit-directly-to-main.md; ../docs/CAMPAIGN_RELEASE_AND_DATAVERSE_TEST_STRATEGY.md; feedback-scope-git-stash-in-shared-worktrees.md (multi-agent worktrees: never unscoped stash/revert); feedback-clear-jest-cache-in-shared-worktrees.md (clear jest cache before citable verification runs after multi-agent edits — stale transform cache = false reds)
