...
- Contact promotion / address provenance / send-gate friction: ../docs/REVIEWER_CONTACT_PROMOTION_AND_ADDRESS_LIFECYCLE.md (S388 problem statement — nothing built, six owner decisions, one LIVE defect in §4.2); ../docs/REVIEWER_FINDER_ENFORCEMENT_CONTRACTS.md
