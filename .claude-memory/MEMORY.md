...
- Reviewer Find latency (incremental plan ACTIVE S397; Step 1 blob cache live; read postmortem before ANY expansion) / warm incident (RESOLVED S396) / Request 1002903: ../SESSION_PROMPT.md; ../docs/agent-wiki/topics/reviewer-workbench-lifecycle.md; feedback-latency-plan-scope-accretion-postmortem.md; ../docs/REVIEWER_FIND_WARM_RECONCILIATION_INCIDENT_2026-08-03.md; superseded: ../docs/REVIEWER_FIND_PERFORMANCE_PLAN.md, ../docs/REVIEWER_WARM_STAGE_PRODUCER_SPEC.md.
