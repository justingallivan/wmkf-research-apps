...
- Reviewer address trust / remedies: ../docs/REVIEWER_ADDRESS_TRUST_AND_CONFLICT_RESOLUTION_PLAN.md (S391 source-built; second Opus findings remediated and locally green; third review pending; Wave 17/runtime blocked.)
