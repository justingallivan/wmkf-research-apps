...
- Reviewer address trust / remedies: ../docs/REVIEWER_ADDRESS_TRUST_AND_CONFLICT_RESOLUTION_PLAN.md (S391 fail-closed state machine built after Fable review; final review pending; Wave 17/runtime blocked.)
