...
- Reviewer Find warm incident (RESOLVED S396 by revert to 94c5b9d9) / Request 1002903 / any new latency plan: ../docs/REVIEWER_FIND_WARM_RECONCILIATION_INCIDENT_2026-08-03.md (resolution section first); feedback-latency-plan-scope-accretion-postmortem.md; superseded: ../docs/REVIEWER_FIND_PERFORMANCE_PLAN.md, ../docs/REVIEWER_WARM_STAGE_PRODUCER_SPEC.md.
