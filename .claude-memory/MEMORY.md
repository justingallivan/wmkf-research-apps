...
- Reviewer address trust / remedies: ../docs/REVIEWER_ADDRESS_TRUST_AND_CONFLICT_RESOLUTION_PLAN.md; ../docs/REVIEWER_EMAIL_CONFLICT_SELF_SERVICE_PLAN.md (S391 fail-closed state machine plus direct stored/found Workbench choice and structural AkoyaGO retry are Production-live as of 2026-08-20; signed-in smoke verified the exact-choice dialog through neutral Cancel; one active legacy repair alert remains for compatibility.)
