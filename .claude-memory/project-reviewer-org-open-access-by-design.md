...
description: "Owner principle for global reviewer merge and staff-wide document reads: org-open by design. Narrow Production-live exception: request-bound Reviewer Follow-up mutations are lead-PD/superuser-only at the server boundary."
metadata:
  type: project
  status: active
  scope: security
  last_verified: 2026-09-02 — T1 merge and D4 reads remain org-open; request-bound mutation exception is Production-live and authenticated-read verified
---
...
those actions on 2026-09-02. That boundary is Production-live from runtime
merge `acf40fb8`; authenticated Production verification confirmed the broader
read projection without exercising a write.
...
is implemented, automated-test verified, independently reviewed, and
Production-live as documented by
...
- **Request-bound Reviewer Follow-up mutations — Production-live exception
  (owner, 2026-09-02):** server-authoritative lead-PD/superuser writes are
  deployed; other authorized staff remain organization-wide readers. This does
  not alter T1 or D4.
