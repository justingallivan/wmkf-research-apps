...
- **An app = (a prompt in Dataverse) × (a thin adapter).** "18 apps" → N prompts + a few adapter shapes (Workbench tab · PA trigger · ad hoc standalone).
