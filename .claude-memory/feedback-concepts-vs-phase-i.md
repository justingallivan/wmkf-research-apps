...
- Related: `project-staged-review-pipeline.md` mentions 3-stage automated triage (fit screen → intelligence brief → virtual panel). Concepts are likely an input to stage 1, Phase I to stage 2, etc. — confirm with user before mapping.
