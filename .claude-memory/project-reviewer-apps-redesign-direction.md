...
- **Group A SHIPPED (`f47d1f09`, `66f33b8c`):** the **Overview** (per-request command center) + **Status**
  ...
  reads it from there). **5 placeholder lifecycle tabs remain** (Initial/Pre-Site-Visit/Final Writeup,
  Reviews, Site Visit) — scoped in `docs/REQUEST_WORKBENCH_BUILD_PLAN.md` §"Remaining lifecycle tabs".
